...
<div style="max-width: 700px; margin: 0 auto; background: #ffffff; font-family: Arial, sans-serif; color: #333; border: 1px solid #e0e0e0; border-radius: 10px; overflow: hidden;">
  ...
  <div style="padding: 10px 30px;">
    ...
    <h4 style="color: #1e3a8a;">Your Impact:</h4>
    <p style="margin-bottom: 20px;">Your donation will go toward:</p>
    <ul style="padding-left: 20px; color: #374151;">
      <li>💉 Vaccinations and medical care for rescued animals</li>
      <li>🍖 Daily food and nutrition for our furry friends</li>
      <li>🏠 Temporary shelters and foster programs</li>
    </ul>
  ...
  <!-- Footer -->
  <div style="background:rgb(200, 206, 219); padding: 15px; font-size: 13px; color:rgb(38, 79, 160); text-align: center;">
    <p style="margin: 4px 0;">📍 123 Animal Care Drive, Miami, FL 33101</p>
    <p style="margin: 4px 0;">📞 (123) 456-7690 | ✉️ support@rexvets.com</p>
    <p style="margin: 4px 0;">🌐 <a href="https://www.rexvets.com" style="color:rgb(16, 45, 143);">www.rexvets.org</a></p>
  </div>
</div>
`;
};
